...
{
    class RussianTankBuilder : TankBuilder
    {
        private int chassisColorId = 2;
        private int chassisId = 1;
        private int tracksId = 1;
        private int barrelId = 1;

        public RussianTankBuilder(bool isPlayer) : base(isPlayer)
        {
